        ...
        return (
            <Element name="portfolio">
                <div className='outer-container dark'>
                    ...
                    <br />
                    <h4 className='element-name prjcolor'>BloggyBlog2</h4>
                    <div className='container btmln right' style={{textAlign: 'right'}}>
                        ...
                        <div className='p'>Blog app with API to create/update blogs, add images to gallery, with redux for state management and a simple socket.io chatboard. Rebuild of personal project done at DevMountain. (No auth set up for admin).
                            <br />
                    ...
                    <br />
                    <h4 className='element-name prjcolor'>BloggyBlog</h4>
                    <div className='container btmln left'>
                        <div className='p'>Personal project for DevMountain. Blog app with API to create/update blogs, add images to gallery, with redux for state management, uses Auth0 for admin section.
                            <br />
                            <h5>Technologies used:</h5>
                            <img src={require('../../assets/react-logo.png')} alt="" />
                            <img src={require('../../assets/node.png')} alt="" />
